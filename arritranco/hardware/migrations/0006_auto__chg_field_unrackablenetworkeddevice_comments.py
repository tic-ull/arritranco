...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnrackableNetworkedDevice.comments'
        db.alter_column(u'hardware_unrackablenetworkeddevice', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UnrackableNetworkedDevice.comments'
        raise RuntimeError("Cannot reverse this migration. 'UnrackableNetworkedDevice.comments' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UnrackableNetworkedDevice.comments'
        db.alter_column(u'hardware_unrackablenetworkeddevice', 'comments', self.gf('django.db.models.fields.TextField')())
