...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RackPlace.end_unit'
        db.delete_column('hardware_rackplace', 'end_unit')

        # Deleting field 'RackPlace.start_unit'
        db.delete_column('hardware_rackplace', 'start_unit')

        # Adding field 'RackPlace.units'
        db.add_column('hardware_rackplace', 'units', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=50), keep_default=False)

        # Deleting field 'PhysicalServer.units'
        db.delete_column('hardware_physicalserver', 'units')

        # Adding field 'PhysicalServer.memory'
        db.add_column('hardware_physicalserver', 'memory', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RackPlace.end_unit'
        db.add_column('hardware_rackplace', 'end_unit', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)

        # Adding field 'RackPlace.start_unit'
        db.add_column('hardware_rackplace', 'start_unit', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)

        # Deleting field 'RackPlace.units'
        db.delete_column('hardware_rackplace', 'units')

        # Adding field 'PhysicalServer.units'
        db.add_column('hardware_physicalserver', 'units', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=0, max_length=50), keep_default=False)

        # Deleting field 'PhysicalServer.memory'
        db.delete_column('hardware_physicalserver', 'memory')
