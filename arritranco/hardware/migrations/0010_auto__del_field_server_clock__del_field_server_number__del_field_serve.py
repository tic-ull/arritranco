...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Server.processor_type'
        db.add_column('hardware_server', 'processor_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hardware.ProcessorType'], null=True, blank=True), keep_default=False)

        # Adding field 'Server.processor_clock'
        db.add_column('hardware_server', 'processor_clock', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Server.processor_number'
        db.add_column('hardware_server', 'processor_number', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Server.processor_type'
        db.delete_column('hardware_server', 'processor_type_id')

        # Deleting field 'Server.processor_clock'
        db.delete_column('hardware_server', 'processor_clock')

        # Deleting field 'Server.processor_number'
        db.delete_column('hardware_server', 'processor_number')
