...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hardware_macshistory', (
        ...
        db.send_create_signal('hardware', ['MACsHistory'])
        ...
        db.create_table('hardware_networkport', (
            ...
            ('uplink', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        ...
        # Adding field 'RackPlace.base_unit'
        db.add_column('hardware_rackplace', 'base_unit', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MACsHistory'
        db.delete_table('hardware_macshistory')
        ...
        # Deleting field 'RackPlace.base_unit'
        db.delete_column('hardware_rackplace', 'base_unit')
