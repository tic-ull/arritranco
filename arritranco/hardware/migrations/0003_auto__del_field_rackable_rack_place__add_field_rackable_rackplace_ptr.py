...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rackable.rack_place'
        db.delete_column('hardware_rackable', 'rack_place_id')

        # Adding field 'Rackable.rackplace_ptr'
        db.add_column('hardware_rackable', 'rackplace_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['hardware.RackPlace'], unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Rackable.rack_place'
        db.add_column('hardware_rackable', 'rack_place', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['hardware.RackPlace']), keep_default=False)

        # Deleting field 'Rackable.rackplace_ptr'
        db.delete_column('hardware_rackable', 'rackplace_ptr_id')
