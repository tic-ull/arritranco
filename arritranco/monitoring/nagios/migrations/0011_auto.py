...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field excluded_ips on 'NagiosHardwarePolicyCheckOpts'
        m2m_table_name = db.shorten_name(u'nagios_nagioshardwarepolicycheckopts_excluded_ips')
        db.create_table(m2m_table_name, (
            ...
            ('ip', models.ForeignKey(orm[u'network.ip'], null=False))
        ))
        db.create_unique(m2m_table_name, ['nagioshardwarepolicycheckopts_id', 'ip_id'])


    def backwards(self, orm):
        # Removing M2M table for field excluded_ips on 'NagiosHardwarePolicyCheckOpts'
        db.delete_table(db.shorten_name(u'nagios_nagioshardwarepolicycheckopts_excluded_ips'))
