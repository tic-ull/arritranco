...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NagiosCheck.options'
        db.delete_column(u'nagios_nagioscheck', 'options')


    def backwards(self, orm):
        # Adding field 'NagiosCheck.options'
        db.add_column(u'nagios_nagioscheck', 'options',
