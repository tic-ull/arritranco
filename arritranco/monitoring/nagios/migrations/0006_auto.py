...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field default_contact_groups on 'NagiosCheck'
        m2m_table_name = db.shorten_name(u'nagios_nagioscheck_default_contact_groups')
        ...
        db.create_unique(m2m_table_name, ['nagioscheck_id', 'nagioscontactgroup_id'])


    def backwards(self, orm):
        # Removing M2M table for field default_contact_groups on 'NagiosCheck'
        db.delete_table(db.shorten_name(u'nagios_nagioscheck_default_contact_groups'))
