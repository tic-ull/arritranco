...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute("CREATE SEQUENCE nagios_nagioshardwarepolicycheckopts_id_seq")
        db.execute("SELECT setval('nagios_nagioshardwarepolicycheckopts_id_seq', (SELECT MAX(id) FROM nagios_nagioshardwarepolicycheckopts))")
        db.execute("ALTER TABLE nagios_nagioshardwarepolicycheckopts ALTER COLUMN id SET DEFAULT nextval('nagios_nagioshardwarepolicycheckopts_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE nagios_nagiosmachinecheckopts_id_seq")
        db.execute(
            "SELECT setval('nagios_nagiosmachinecheckopts_id_seq', (SELECT MAX(id) FROM nagios_nagiosmachinecheckopts))")
        db.execute(
            "ALTER TABLE nagios_nagiosmachinecheckopts ALTER COLUMN id SET DEFAULT nextval('nagios_nagiosmachinecheckopts_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE nagios_nagiosservicecheckopts_id_seq")
        db.execute(
            "SELECT setval('nagios_nagiosservicecheckopts_id_seq', (SELECT MAX(id) FROM nagios_nagiosservicecheckopts))")
        db.execute(
            "ALTER TABLE nagios_nagiosservicecheckopts ALTER COLUMN id SET DEFAULT nextval('nagios_nagiosservicecheckopts_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE nagios_nagiosunrackablenetworkeddevicecheckopts_id_seq")
        db.execute(
            "SELECT setval('nagios_nagiosunrackablenetworkeddevicecheckopts_id_seq', (SELECT MAX(id) FROM nagios_nagiosunrackablenetworkeddevicecheckopts))")
        db.execute(
            "ALTER TABLE nagios_nagiosunrackablenetworkeddevicecheckopts ALTER COLUMN id SET DEFAULT nextval('nagios_nagiosunrackablenetworkeddevicecheckopts_id_seq'::regclass)")
