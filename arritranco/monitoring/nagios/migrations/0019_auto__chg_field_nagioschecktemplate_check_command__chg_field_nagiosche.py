...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NagiosCheckTemplate.check_command'
        db.alter_column(u'nagios_nagioschecktemplate', 'check_command', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'NagiosCheckTemplate.first_notification_delay'
        db.alter_column(u'nagios_nagioschecktemplate', 'first_notification_delay', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'NagiosCheckTemplate.check_command'
        db.alter_column(u'nagios_nagioschecktemplate', 'check_command', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'NagiosCheckTemplate.first_notification_delay'
        db.alter_column(u'nagios_nagioschecktemplate', 'first_notification_delay', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'nagios.nagioschecktemplate': {
            ...
            'first_notification_delay': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'blank': 'True'}),
