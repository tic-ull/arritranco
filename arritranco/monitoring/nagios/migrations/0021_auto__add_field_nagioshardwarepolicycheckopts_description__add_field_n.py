...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NagiosHardwarePolicyCheckOpts.description'
        db.add_column(u'nagios_nagioshardwarepolicycheckopts', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'NagiosUnrackableNetworkedDeviceCheckOpts.description'
        db.add_column(u'nagios_nagiosunrackablenetworkeddevicecheckopts', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'NagiosMachineCheckOpts.description'
        db.add_column(u'nagios_nagiosmachinecheckopts', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'NagiosServiceCheckOpts.description'
        db.add_column(u'nagios_nagiosservicecheckopts', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NagiosHardwarePolicyCheckOpts.description'
        db.delete_column(u'nagios_nagioshardwarepolicycheckopts', 'description')

        # Deleting field 'NagiosUnrackableNetworkedDeviceCheckOpts.description'
        db.delete_column(u'nagios_nagiosunrackablenetworkeddevicecheckopts', 'description')

        # Deleting field 'NagiosMachineCheckOpts.description'
        db.delete_column(u'nagios_nagiosmachinecheckopts', 'description')

        # Deleting field 'NagiosServiceCheckOpts.description'
        db.delete_column(u'nagios_nagiosservicecheckopts', 'description')
