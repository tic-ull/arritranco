...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NagiosCheck.template'
        db.add_column(u'nagios_nagioscheck', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nagios.NagiosCheckTemplate'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NagiosCheck.template'
        db.delete_column(u'nagios_nagioscheck', 'template_id')
    ...
    models = {
        ...
        u'nagios.nagioscheck': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nagios.NagiosCheckTemplate']", 'null': 'True'}),
