...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field excluded_os on 'NagiosHardwarePolicyCheckOpts'
        m2m_table_name = db.shorten_name(u'nagios_nagioshardwarepolicycheckopts_excluded_os')
        ...
        db.create_unique(m2m_table_name, ['nagioshardwarepolicycheckopts_id', 'operatingsystem_id'])


    def backwards(self, orm):
        # Removing M2M table for field excluded_os on 'NagiosHardwarePolicyCheckOpts'
        db.delete_table(db.shorten_name(u'nagios_nagioshardwarepolicycheckopts_excluded_os'))
