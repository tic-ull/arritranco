...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NagiosCheckTemplate.parallelize_check'
        db.delete_column(u'nagios_nagioschecktemplate', 'parallelize_check')
    ...
    def backwards(self, orm):
        # Adding field 'NagiosCheckTemplate.parallelize_check'
        db.add_column(u'nagios_nagioschecktemplate', 'parallelize_check',
