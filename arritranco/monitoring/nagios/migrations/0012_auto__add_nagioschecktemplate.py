...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NagiosCheckTemplate'
        db.create_table(u'nagios_nagioschecktemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
            ('active_checks_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('passive_checks_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('parallelize_check', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('obsess_over_service', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('check_freshness', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('notifications_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('event_handler_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('flap_detection_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('failure_prediction_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('process_perf_data', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('retain_status_information', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('retain_nonstatus_information', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_volatile', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('check_period', self.gf('django.db.models.fields.CharField')(default=u'24x7', max_length=55)),
            ('check_interval', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5)),
            ('retry_interval', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('notification_interval', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=720)),
            ('first_notification_delay', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('max_check_attempts', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3)),
            ('notification_period', self.gf('django.db.models.fields.CharField')(default=u'24x7', max_length=55)),
            ('notification_options', self.gf('django.db.models.fields.CharField')(default=u'w,u,c,r', max_length=10)),
            ('register', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'nagios', ['NagiosCheckTemplate'])


    def backwards(self, orm):
        # Deleting model 'NagiosCheckTemplate'
        db.delete_table(u'nagios_nagioschecktemplate')
    ...
    models = {
        ...
        u'nagios.nagioschecktemplate': {
            ...
            'parallelize_check': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'nagios.nagioshardwarepolicycheckopts': {
            ...
            'excluded_ips': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['network.IP']", 'null': 'True', 'blank': 'True'}),
