...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NagiosCheck.template'
        db.alter_column(u'nagios_nagioscheck', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nagios.NagiosCheckTemplate']))

    def backwards(self, orm):

        # Changing field 'NagiosCheck.template'
        db.alter_column(u'nagios_nagioscheck', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nagios.NagiosCheckTemplate'], null=True))
