...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nagios_nagioschecktemplate', 'check_command',
                      self.gf('django.db.models.fields.CharField')(default=u'return-unknown', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NagiosCheckTemplate.freshness_threshold'
        db.delete_column(u'nagios_nagioschecktemplate', 'freshness_threshold')

        # Deleting field 'NagiosCheckTemplate.check_command'
        db.delete_column(u'nagios_nagioschecktemplate', 'check_command')
