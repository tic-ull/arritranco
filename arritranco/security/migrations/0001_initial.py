...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SecurityDevice'
        db.create_table(u'security_securitydevice', (
            (u'unrackablenetworkeddevice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hardware.UnrackableNetworkedDevice'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'security', ['SecurityDevice'])
    ...
    def backwards(self, orm):
        # Deleting model 'SecurityDevice'
        db.delete_table(u'security_securitydevice')
    ...
    models = {
        ...
        u'security.securitydevice': {
            'Meta': {'object_name': 'SecurityDevice', '_ormbases': [u'hardware.UnrackableNetworkedDevice']},
