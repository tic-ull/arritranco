...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Interface.ip'
        db.delete_column(u'inventory_interface', 'ip')
        db.rename_column(u'inventory_interface', 'ip_new_id', 'ip_id')

    def backwards(self, orm):
        # Adding field 'Interface.ip'
        db.add_column(u'inventory_interface', 'ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=0, max_length=15),
                      keep_default=False)
        db.rename_column(u'inventory_interface', 'ip_id', 'ip_new_id')
