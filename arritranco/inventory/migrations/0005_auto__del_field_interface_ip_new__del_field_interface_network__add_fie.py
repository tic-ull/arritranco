...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_interface', 'network_id')

    def backwards(self, orm):
        # Adding field 'Interface.network'
        db.add_column(u'inventory_interface', 'network',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['network.Network'], null=True, blank=True),
                      keep_default=False)
