...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interface.ip_new'
        db.add_column(u'inventory_interface', 'ip_new',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'inventory_balancedservice', (
            ...
            ('fqdn', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ...
        # Deleting field 'Interface.ip_new'
        db.delete_column(u'inventory_interface', 'ip_new_id')
