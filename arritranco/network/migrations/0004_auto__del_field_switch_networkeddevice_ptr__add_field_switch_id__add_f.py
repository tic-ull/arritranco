...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Switch.networkeddevice_ptr'
        db.delete_column(u'network_switch', u'networkeddevice_ptr_id')

        # Adding field 'Switch.id'
        db.add_column(u'network_switch', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Adding field 'Switch.main_ip'
        db.add_column(u'network_switch', 'main_ip',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['network.IP']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Switch.networkeddevice_ptr'
        db.add_column(u'network_switch', u'networkeddevice_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hardware.NetworkedDevice'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Switch.id'
        db.delete_column(u'network_switch', u'id')

        # Deleting field 'Switch.main_ip'
        db.delete_column(u'network_switch', 'main_ip_id')
